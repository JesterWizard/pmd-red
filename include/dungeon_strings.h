...
extern const u8 *const gText_AcuteSnifferItemCount;
...
extern const u8 *const gText_MoneyCyan;
...
extern const u8 *const gText_Pokemon0HpWentUpCyan;
extern const u8 *const gText_Pokemon0AttackWentUpCyan;
extern const u8 *const gText_Pokemon0DefenseWentUpCyan;
extern const u8 *const gText_Pokemon0SpAtkWentUpCyan;
extern const u8 *const gText_Pokemon0SpDefWentUpCyan;
...
extern const u8 *const gText_Pokemon0GainedExpPointsCyan;
...
extern const u8 *const gJobRescueThankYouMsg;
extern const u8 *const gJobRescueEscapedMsg;
...
extern const u8 *const gJobDeliverThankYouMsg;
extern const u8 *const gJobDeliverLeftMsg;
...
extern const u8 *const gJobEscortThankYouMsg;
extern const u8 *const gJobEscortLeftMsg;
...
extern const u8 *const gText_BodyguardTookHit;
...
extern const u8 *const gTeamToolboxFmtPtr;
