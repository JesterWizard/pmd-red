...
extern const u8 *const gTextStat;
extern const u8 *const gTextPhysical;
extern const u8 *const gTextSpecial;
...
extern const u8 *const gText_ExpPtsUnkMacroCyan;
extern const u8 *const gText_ToNextLevel;
extern const u8 *const gText_ToNextLevelCyan;
...
extern const u8 *const gText_SummaryAttack;
extern const u8 *const gText_SummaryAttackBoost;
extern const u8 *const gText_SummaryDefense;
extern const u8 *const gText_SummaryDefenseBoost;
extern const u8 *const gText_SummarySpAtk;
extern const u8 *const gText_SummarySpAtkBoost;
extern const u8 *const gText_SummarySpDef;
extern const u8 *const gText_SummarySpDefBoost;
...
extern const u8 *const gText_SummaryTactic;
