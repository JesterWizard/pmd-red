...
#define INVENTORY_SIZE_VANILLA 20
#define INVENTORY_SIZE 48 /* physical array / save max */
#define INVENTORY_SIZE_RANK_BAG_MAX 48
#define BAG_ITEMS_PER_PAGE_VANILLA 10
