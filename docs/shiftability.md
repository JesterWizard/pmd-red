...
| `pmd_red.gba` | ~27.5 MiB (varies with current strips) |

Savings: no 32 MiB pad, ground **BPC/BMA** LZ77 (~1.43 MiB), and unused opaque
blobs stripped from the modern link (~2.36 MiB). See `SESSION_HISTORY.md`.
