...
const s32 gReqIQSkillPts[NUM_IQ_SKILLS] =
{
    ...
    [IQ_EXP_ELITE] = 230,
    [IQ_TIME_TRIPPER] = 350,
    [IQ_NATURAL_GIFTER] = 500,
    [IQ_QUICK_STRIKER] = 550,
    [IQ_PIERCE_HURLER] = 600,
    [IQ_MAP_SURVEYOR] = 580,
    [IQ_INTIMIDATOR] = 560,
    [IQ_FAST_FRIEND] = 550,
    [IQ_EXTRA_STRIKER] = 520,
    [IQ_AGGRESSOR] = 220,
    [IQ_DEFENDER] = 230,
    [IQ_GAP_PROBER] = 170,
    [IQ_PRACTICE_SWINGER] = 195,
    [IQ_WISE_HEALER] = 175,
    [IQ_BRICK_TOUGH] = 100,
    [IQ_ACUTE_SNIFFER] = 50,
    [IQ_CHEERLEADER] = 30,
...
const s32 gIQSkillGroups[NUM_IQ_SKILLS] = {
    ...
    [IQ_TYPE_GUARD] = 4,
    [IQ_STATUS_EXPERT] = 8,
    [IQ_EFFICIENT_EATER] = 14,
    [IQ_TREASURE_SENSE] = 16,
    [IQ_DEEP_BREATHER] = 6,
    [IQ_COIN_WATCHER] = 17,
    [IQ_HIT_AND_RUNNER] = 7,
    [IQ_CONCENTRATOR] = 4,
