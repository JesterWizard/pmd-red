...
const u8 *const gText_AcuteSnifferItemCount = _("{POKEMON_0} sniffed around.\nThere seem to be {VALUE_0} items on this floor.");
...
const u8 *const gText_DungeonTeamFull = _("The team is full.\nSomeone must return to the Friend Area.");
const u8 *const gText_SendNewRecruitHomeQ = _("Send {POKEMON_0} to the Friend Area?");
const u8 *const gText_SendHome = _("Send Home");
...
const u8 *const gText_Pokemon0HpWentUpCyan = _("{POKEMON_0}'s HP went up {color CYAN_RAW}{VALUE_0}{reset}!");
const u8 *const gText_Pokemon0AttackWentUpCyan = _("{POKEMON_0}'s Attack went up {color CYAN_RAW}{VALUE_1}{reset}!");
const u8 *const gText_Pokemon0DefenseWentUpCyan = _("{POKEMON_0}'s Defense went up {color CYAN_RAW}{VALUE_2}{reset}!");
const u8 *const gText_Pokemon0SpAtkWentUpCyan = _("{POKEMON_0}'s Sp. Atk. went up {color CYAN_RAW}{VALUE_3}{reset}!");
const u8 *const gText_Pokemon0SpDefWentUpCyan = _("{POKEMON_0}'s Sp. Def. went up {color CYAN_RAW}{VALUE_4}{reset}!");
...
const u8 *const gText_BodyguardTookHit = _("{POKEMON_0} protected {POKEMON_1}!");
...
const u8 *const gTeamToolboxFmtPtr = _("Team Toolbox %d/%d");
...
const u8 *const gFloorModifierPoisonousAirMessage = _("Floor Modifier: Poisonous Air!\nHP cannot be regenerated by walking!");
