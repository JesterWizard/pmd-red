...
static const struct ScriptCommand s_gs12_g0_s0_station_sref_script[] = { /* 0x81e1954 */
  ...
  LABEL(2), /* = 0x02 */
    ...
    COND_EQUAL(STARTMODE_CONTINUE_GAME, /* to label */ 6),
    COND_EQUAL(STARTMODE_GROUND, /* to label */ 7),
    COND_EQUAL(STARTMODE_DUNGEON_LOST, /* to label */ 8),
    COND_EQUAL(STARTMODE_11, /* to label */ 8),
    COND_EQUAL(STARTMODE_10, /* to label */ 9),
    COND_EQUAL(STARTMODE_DUNGEON_WON, /* to label */ 10),
    JUMP_LABEL(6),
  LABEL(7), /* = 0x07 */
...
static const struct ScriptCommand s_gs12_g9_s0_lives0_dlg0[] = { /* 0x81e2ec0 */
    ...
    PORTRAIT_POS(2, -1, 0),
    UPDATE_NAME(UPDATE_NAME_SPEECH_TYPE, 0x2, 0x73),
    MSG_NPC(2, _(" I'm named Spinda.")),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x73),
...
static const struct ScriptCommand s_gs12_g12_s0_lives0_dlg0[] = { /* 0x81e5884 */
    ...
    CALL_SCRIPT(INIT_SLEEP_FUNC),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x20),
    WAIT_FADE,
    CALL_SCRIPT(WAKEUP_FUNC),
    WAIT(15),
    CALL_SCRIPT(LOOK_AROUND_FUNC),
...
static const struct ScriptCommand s_gs12_g20_s0_lives0_dlg0[] = { /* 0x81e8394 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x4, 0x45),
    AWAIT_CUE(5),
    WAIT_FADE,
    WAIT(60),
...
static const struct ScriptCommand s_gs12_g33_s0_lives0_dlg0[] = { /* 0x81ea094 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x1, 0x22),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x52),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x62),
    WAIT_FADE,
    CALL_SCRIPT(WAKEUP_FUNC),
    WAIT(15),
...
static const struct ScriptCommand s_gs12_g39_s1_lives0_dlg0[] = { /* 0x81eb468 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(6),
    WALK_DIRECTION(48, 0x200, 0x4),
    CALL_SCRIPT(JUMP_ANGRY_FUNC),
    ALERT_CUE(5),
    AWAIT_CUE(6),
    WALK_DIRECTION(48, 0x200, 0x0),
    AWAIT_CUE(6),
    HALT,
};
...
static const struct ScriptCommand s_gs12_g42_s0_lives1_dlg0[] = { /* 0x81ebd04 */
    ...
    MOVE_RELATIVE(0x80, 0x0, 0xA),
    WAIT(30),
    WALK_DIRECTION(64, 0x200, 0x0),
    ALERT_CUE(5),
    HALT,
};
...
static const struct ScriptCommand s_gs12_g42_s0_eff1_script[] = { /* 0x81ebe54 */
    DEBUGINFO_O(2535),
    AWAIT_CUE(7),
    EMOTION_EFFECT(0x10A),
    WALK_RELATIVE_DIST(0x66, -0x30, 0x40),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    WALK_RELATIVE_DIST(0x4C, -0x48, 0x10),
    AWAIT_CUE(7),
    HALT,
};
...
static const struct ScriptCommand s_gs12_g45_s0_station_sref_script[] = { /* 0x81ec1fc */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x0, 0x21),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x1, 0x22),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x37),
    BGM_STOP,
    SET_PLACE_MODE(1),
    FADE_OUT(1, 0x0),
    FADE2_OUT(1, 0x0),
