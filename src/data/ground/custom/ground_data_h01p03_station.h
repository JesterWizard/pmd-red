...
static const struct GroundEventData s_gs107_g0_s0_evts[] = { /* 0x81efb50 */
    /*  0 */ {  66,   3,   0,   0, {   0,  42, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  1 */ {   3,  45,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {   3,  45,   0,   0, {  63,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
