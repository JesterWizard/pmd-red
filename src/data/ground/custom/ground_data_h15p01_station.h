...
static const ScriptRef s_gs142_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs142_g0_s0_station_sref_script }; /* 0x82039ac */
...
static const struct GroundEventData s_gs142_g0_s0_evts[] = { /* 0x8203e80 */
    /*  0 */ {  60,   1,   0,   0, {   0,  38, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
};

static const ScriptRef * const (sStationScripts[]) = { /* 0x8203e8c */
...
const GroundScriptHeader gGroundScript_gs142 = { LPARRAY(s_gs142_groups), s_gs142_links }; /* 0x8203fd0 */
