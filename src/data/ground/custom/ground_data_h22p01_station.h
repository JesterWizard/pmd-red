...
static const ScriptRef s_gs150_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs150_g0_s0_station_sref_script }; /* 0x82089b8 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x8208e54 */
