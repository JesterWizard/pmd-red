...
static const ScriptRef s_gs153_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs153_g0_s0_station_sref_script }; /* 0x820a670 */
...
static const struct GroundEventData s_gs153_g0_s0_evts[] = { /* 0x820aadc */
    ...
    /*  1 */ {  60,   1,   0,   0, {   0,  35, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {   1,  36,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  3 */ {   1,  36,   0,   0, {  59,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
};

static const ScriptRef * const (sStationScripts[]) = { /* 0x820ab0c */
...
const GroundScriptHeader gGroundScript_gs153 = { LPARRAY(s_gs153_groups), s_gs153_links }; /* 0x820ac48 */
