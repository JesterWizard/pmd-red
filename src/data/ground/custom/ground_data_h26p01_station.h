...
static const struct ScriptCommand s_gs154_g0_s0_station_sref_script[] = { /* 0x820ac5c */
  ...
  LABEL(7), /* = 0x07 */
    ...
    JUMP_LABEL(8),
  LABEL(8), /* = 0x08 */
    BGM_SWITCH(MUS_FRIEND_AREA_VOLCANIC_PIT),
    JUMP_SCRIPT(COMMON_ENTER),
};

static const ScriptRef s_gs154_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs154_g0_s0_station_sref_script }; /* 0x820aed8 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820b16c */
...
const GroundScriptHeader gGroundScript_gs154 = { LPARRAY(s_gs154_groups), s_gs154_links }; /* 0x820b280 */
