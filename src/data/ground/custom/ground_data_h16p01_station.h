...
static const ScriptRef s_gs143_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs143_g0_s0_station_sref_script }; /* 0x8204260 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x8204904 */
...
const GroundScriptHeader gGroundScript_gs143 = { LPARRAY(s_gs143_groups), s_gs143_links }; /* 0x8204a68 */
