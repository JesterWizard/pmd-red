...
static const ScriptRef s_gs147_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs147_g0_s0_station_sref_script }; /* 0x8206940 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x8206e44 */
...
const GroundScriptHeader gGroundScript_gs147 = { LPARRAY(s_gs147_groups), s_gs147_links }; /* 0x8206f88 */
