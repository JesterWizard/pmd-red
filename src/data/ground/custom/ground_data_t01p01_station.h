...
static const struct ScriptCommand s_gs1_g1_s0_lives8_dlg2[] = { /* 0x8139a3c */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x50),
    WAIT(1),
...
static const struct ScriptCommand s_gs1_g3_s0_lives0_dlg2[] = { /* 0x813a610 */
    DEBUGINFO_O(763),
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_SPEECH_SELF, 0x0, 0x0),
    WAIT(1),
...
static const struct ScriptCommand s_gs1_g4_s1_lives0_dlg0[] = { /* 0x813a9b4 */
    ...
    SELECT_ENTITIES(-1, 2),
    ALERT_CUE(6),
    EMOTION_EFFECT_EX(-1, 0x58),
    WAIT_EFFECT,
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 127),
    WAIT(60),
    MSG_NPC(2, _(" ....................................\n................................................\n................................................")),
...
static const struct ScriptCommand s_gs1_g4_s3_lives0_dlg3[] = { /* 0x813b7d8 */
  ...
  LABEL(0), /* = 0x00 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(8, DIR_TRANS_10, 0),
    ALERT_CUE(5),
    AWAIT_CUE(6),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g5_s1_obj1_dlg0[] = { /* 0x813c0d8 */
    ...
    SELECT_ANIMATION(8),
    { 0x5d, 0x00,  0x0000,  0x0000007f,  0x00000000, NULL },
    WALK_RELATIVE_DIST(0x200, -0x18, -4),
    WALK_RELATIVE_DIST(0x100, -8, -2),
    WALK_RELATIVE_DIST(0x80, -2, -1),
    SET_OBJ_FLAGS(0x4),
    SET_OBJ_FLAGS(0x40),
    RET,
};
...
static const struct ScriptCommand s_gs1_g5_s1_obj2_dlg0[] = { /* 0x813c1e8 */
    ...
    SELECT_ANIMATION(8),
    { 0x5d, 0x00,  0x0000,  0x0000007f,  0x00000000, NULL },
    WALK_RELATIVE_DIST(0x200, -0x18, 0x4),
    WALK_RELATIVE_DIST(0x100, -8, 0x2),
    WALK_RELATIVE_DIST(0x80, -2, 0x1),
    SET_OBJ_FLAGS(0x4),
    SET_OBJ_FLAGS(0x40),
    RET,
};
...
static const struct ScriptCommand s_gs1_g5_s4_lives0_dlg0[] = { /* 0x813c7e4 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    AWAIT_CUE(5),
    ROTATE_TO_LIVES(8, DIR_TRANS_10, 127),
...
static const struct ScriptCommand s_gs1_g5_s4_lives2_dlg0[] = { /* 0x813cdf0 */
  ...
  LABEL(1), /* = 0x01 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO_WAYPOINT(8, DIR_TRANS_10, 3),
    SELECT_ANIMATION(33),
    CLEAR_OBJ_FLAGS(0x4),
  ...
  LABEL(3), /* = 0x03 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO_WAYPOINT(4, DIR_TRANS_10, 3),
    WAIT(10),
    ALERT_CUE(5),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g7_s1_lives0_dlg0[] = { /* 0x813e880 */
    ...
    TEXTBOX_CLEAR,
    ROTATE_TO_LIVES(8, DIR_TRANS_10, 4),
    WAIT(10),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs1_g8_s0_lives7_dlg2[] = { /* 0x813efbc */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x1, 0x4F),
    WAIT(1),
...
static const struct ScriptCommand s_gs1_g8_s2_lives6_dlg0[] = { /* 0x813f3fc */
    DEBUGINFO_O(2064),
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x8, 0x0),
    WAIT(1),
    RET,
};
...
static const struct ScriptCommand s_gs1_g8_s2_lives7_dlg0[] = { /* 0x813f44c */
    DEBUGINFO_O(2072),
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x9, 0x0),
    WAIT(1),
    RET,
};
...
static const struct ScriptCommand s_gs1_g10_s0_eff0_script[] = { /* 0x814104c */
    ...
    AWAIT_CUE(4),
    CAMERA_INIT_PAN,
    WALK_DIRECTION(40, 0x200, 0x2),
    ALERT_CUE(5),
    AWAIT_CUE(4),
    WALK_DIRECTION(40, 0x200, 0x6),
    ALERT_CUE(5),
    AWAIT_CUE(4),
    WALK_DIRECTION(40, 0x200, 0x2),
    ALERT_CUE(5),
    AWAIT_CUE(4),
    WALK_DIRECTION(32, 0x300, 0x6),
    AWAIT_CUE(4),
    WALK_DIRECTION(48, 0x200, 0x2),
    ALERT_CUE(5),
    AWAIT_CUE(4),
...
static const struct ScriptCommand s_gs1_g10_s0_lives2_dlg0[] = { /* 0x81412bc */
    ...
    CLEAR_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
    CAMERA_PAN(256, 22),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 78),
    ALERT_CUE(6),
    WAIT(30),
    AWAIT_CUE(5),
    WAIT(15),
    ...
    TEXTBOX_CLEAR,
    WAIT(10),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 77),
    ALERT_CUE(9),
    AWAIT_CUE(5),
    ...
    WAIT(4),
    ALERT_CUE(4),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 85),
    ALERT_CUE(6),
    AWAIT_CUE(5),
    PORTRAIT(0, 0x4, -2),
    ...
    ALERT_CUE(14),
    WAIT(20),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 88),
    WAIT(1),
    ALERT_CUE(6),
    WAIT(1),
    ALERT_CUE(9),
    ...
    ALERT_CUE(4),
    AWAIT_CUE(5),
    UPDATE_NAME(UPDATE_NAME_CLEAR, 0x5, 0x0),
...
static const struct ScriptCommand s_gs1_g10_s0_lives7_dlg0[] = { /* 0x81433e4 */
    ...
    AWAIT_CUE(7),
    AWAIT_CUE(7),
    WALK_DIRECTION(16, 0x200, 0x6),
    WALK_DIRECTION(16, 0x100, 0x6),
    ALERT_CUE(13),
    ALERT_CUE(14),
    WAIT(48),
    CALL_SCRIPT(SMILE_START_FUNC),
    ...
    ALERT_CUE(5),
    AWAIT_CUE(7),
    WALK_DIRECTION(8, 0x100, 0x3),
    ROTATE_TO(4, DIR_TRANS_11, DIRECTION_SOUTHWEST),
    WAIT(50),
    ROTATE_TO(4, DIR_TRANS_11, DIRECTION_EAST),
    WAIT(70),
    WALK_DIRECTION(48, 0x100, 0x2),
    AWAIT_CUE(7),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g10_s0_lives11_dlg0[] = { /* 0x8143934 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(9),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINLEFT1, 85),
    ALERT_CUE(5),
    AWAIT_CUE(9),
    ROTATE_TO(4, DIR_TRANS_11, DIRECTION_NORTH),
    AWAIT_CUE(9),
...
static const struct ScriptCommand s_gs1_g10_s1_lives2_dlg0[] = { /* 0x8143e74 */
    DEBUGINFO_O(3072),
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x7, 0x0),
    WALK_GRID(256, 32),
    AWAIT_CUE(12),
    WAIT(30),
    CLEAR_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
...
static const struct ScriptCommand s_gs1_g10_s2_lives0_dlg0[] = { /* 0x8143f74 */
    DEBUGINFO_O(3091),
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_SPEECH_SELF, 0x5, 0x0),
...
static const struct ScriptCommand s_gs1_g11_s0_lives6_dlg2[] = { /* 0x8144320 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x1, 0x4D),
    WAIT(1),
...
static const struct ScriptCommand s_gs1_g14_s0_lives8_dlg2[] = { /* 0x8145944 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x50),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x4E),
    WAIT(1),
...
static const struct ScriptCommand s_gs1_g17_s0_lives0_dlg0[] = { /* 0x8146704 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x5, 0x62),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x6, 0x63),
    WAIT(30),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINRIGHT1, 4),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs1_g21_s0_lives0_dlg0[] = { /* 0x81484d4 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x7, 0x61),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x8, 0x52),
    CLEAR_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
    ...
    FANFARE_PLAY2(463),
    CALL_SCRIPT(NOTICE_FUNC),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 54),
    ...
    ALERT_CUE(6),
    ALERT_CUE(10),
    ROTATE_TO_LIVES(10, DIR_TRANS_10, 54),
    WAIT(30),
    ...
    ALERT_CUE(10),
    ALERT_CUE(11),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 91),
    WAIT(15),
    ALERT_CUE(4),
    WAIT(30),
    ALERT_CUE(7),
    ...
    FANFARE_PLAY2(464),
    CALL_SCRIPT(NOTICE_FUNC),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 34),
  ...
  LABEL(35), /* = 0x23 */
    ...
    TEXTBOX_CLEAR,
    AWAIT_CUE_COND(6, 0),
    ROTATE_TO_LIVES(2, DIR_TRANS_10, 34),
    ALERT_CUE(9),
    ALERT_CUE(10),
    ALERT_CUE(11),
    ALERT_CUE(7),
...
static const struct ScriptCommand s_gs1_g21_s0_lives1_dlg0[] = { /* 0x814a970 */
    ...
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(10, DIR_TRANS_10, 91),
    AWAIT_CUE(6),
    WALK_DIRECT(150, 54),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 91),
    AWAIT_CUE(6),
    ...
    AWAIT_CUE(6),
    CALL_SCRIPT(NOTICE_FUNC),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 0),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 91),
    AWAIT_CUE(6),
    AWAIT_CUE(6),
  ...
  LABEL(1), /* = 0x01 */
    WAIT(15),
    WALK_RELATIVE(256, 16, 0),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 80),
    ALERT_CUE(5),
    AWAIT_CUE(6),
    SELECT_ANIMATION(0xB),
    HEIGHT_TO(0x200, 0xA),
    ...
    AWAIT_CUE(6),
    SELECT_ANIMATION(2),
    MOVE_RELATIVE(0x4C, -8, -8),
    EMOTION_EFFECT(EMOTION_EFFECT_SHOCK),
    ROTATE_TO(2, DIR_TRANS_SPINLEFT1, DIRECTION_NORTH),
    WAIT(15),
    MOVE_RELATIVE(0x4C, -8, 0x8),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(2, DIR_TRANS_10, 0),
    EMOTION_EFFECT(EMOTION_EFFECT_SHOCK),
    AWAIT_CUE(6),
    CALL_SCRIPT(SHOCK_FUNC),
    CALL_SCRIPT(SHOCK_FUNC),
...
static const struct ScriptCommand s_gs1_g21_s0_lives2_dlg0[] = { /* 0x814aee0 */
    ...
    CALL_SCRIPT(SMILE_END_FUNC),
    AWAIT_CUE(7),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 77),
    AWAIT_CUE_COND(5, 0),
    AWAIT_CUE(7),
...
static const struct ScriptCommand s_gs1_g21_s0_lives4_dlg0[] = { /* 0x814b6a0 */
  ...
  LABEL(1), /* = 0x01 */
    ...
    SELECT_ANIMATION(0xC),
    STOP_ANIMATION_ON_CURRENT_FRAME,
    MOVE_RELATIVE(0x80, 0x18, 0x0),
    { 0x57, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    SELECT_ANIMATION(2),
    AWAIT_CUE(9),
    MOVE_RELATIVE(0x4C, 0x8, 0x0),
    AWAIT_CUE(9),
    WAIT(15),
    MOVE_RELATIVE(0x300, -0x30, 0x0),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g21_s0_lives5_dlg0[] = { /* 0x814bad0 */
    ...
    AWAIT_CUE(10),
    SELECT_ANIMATION(2),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINLEFT1, 54),
    AWAIT_CUE(10),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 54),
    AWAIT_CUE(10),
    ROTATE_TO_LIVES(5, DIR_TRANS_10, 91),
    AWAIT_CUE(10),
    WALK_GRID(128, 60),
  ...
  LABEL(1), /* = 0x01 */
    ...
    MOVE_RELATIVE(0x4C, -8, 0x0),
    AWAIT_CUE(10),
    MOVE_RELATIVE(0x4C, 0x0, 0x8),
    AWAIT_CUE(10),
    ROTATE_TO(5, DIR_TRANS_SPINRIGHT1, DIRECTION_WEST),
    WAIT(15),
    MOVE_RELATIVE(0x200, -8, 0x8),
    SET_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g21_s0_lives7_dlg0[] = { /* 0x814c4b0 */
  ...
  LABEL(1), /* = 0x01 */
    CALL_SCRIPT(NOTICE_FUNC),
    WAIT_EFFECT,
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 91),
    AWAIT_CUE(12),
    CALL_LABEL(2),
    CALL_SCRIPT(SHOCK_FUNC),
    WAIT_EFFECT,
...
static const struct ScriptCommand s_gs1_g21_s0_lives11_dlg0[] = { /* 0x814cfe0 */
    ...
    CALL_SCRIPT(JUMP_SURPRISE_FUNC),
    WAIT(15),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 71),
    SELECT_ANIMATION(4),
    AWAIT_CUE(16),
    CALL_SCRIPT(NOTICE_FUNC),
    WAIT_EFFECT,
...
static const struct ScriptCommand s_gs1_g21_s0_lives12_dlg0[] = { /* 0x814d270 */
    ...
    CALL_SCRIPT(JUMP_SURPRISE_FUNC),
    WAIT(15),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 70),
    SELECT_ANIMATION(4),
    AWAIT_CUE(17),
    CALL_SCRIPT(NOTICE_FUNC),
    WAIT_EFFECT,
...
static const struct ScriptCommand s_gs1_g23_s0_eff0_script[] = { /* 0x814db44 */
    ...
    AWAIT_CUE(4),
    CAMERA_INIT_PAN,
    WALK_DIRECTION(32, 0x100, 0x6),
    AWAIT_CUE(4),
    WALK_DIRECTION(28, 0x100, 0x2),
    AWAIT_CUE(4),
    WALK_DIRECTION(64, 0x99, 0x6),
    ALERT_CUE(5),
    AWAIT_CUE(4),
    END_DELETE,
};
...
static const struct ScriptCommand s_gs1_g23_s0_lives0_dlg0[] = { /* 0x814dc14 */
    ...
    AWAIT_CUE(5),
    PORTRAIT_REP(0x0001, 0x00000003),
    ROTATE_TO_LIVES(1, DIR_TRANS_11, 91),
    ...
    ALERT_CUE(13),
    AWAIT_CUE(5),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 34),
    WAIT(45),
    PORTRAIT_REP(0x0002, 0x00000041),
    ...
    ALERT_CUE(10),
    AWAIT_CUE(5),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 91),
    WAIT(30),
    ALERT_CUE(7),
    ALERT_CUE(12),
    ALERT_CUE(13),
    ...
    ALERT_CUE(6),
    ALERT_CUE(16),
    ROTATE_TO_LIVES(8, DIR_TRANS_11, 54),
    WAIT(30),
    PORTRAIT(PLACEMENT_RIGHT_BOTTOM_FLIP, 0x0006, 0x00000000),
...
static const struct ScriptCommand s_gs1_g23_s0_lives1_dlg0[] = { /* 0x8150a08 */
    ...
    AWAIT_CUE(6),
    WAIT(5),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 54),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 91),
    AWAIT_CUE(6),
    ROTATE_TO(4, DIR_TRANS_10, DIRECTION_EAST),
...
static const struct ScriptCommand s_gs1_g23_s0_lives2_dlg0[] = { /* 0x8150cb8 */
    ...
    AWAIT_CUE(16),
    WAIT(5),
    ROTATE_TO_LIVES(8, DIR_TRANS_10, 54),
    AWAIT_CUE(16),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g23_s0_lives3_dlg0[] = { /* 0x8150de8 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO_LIVES(8, DIR_TRANS_11, 77),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 93),
    AWAIT_CUE(7),
    CALL_SCRIPT(NOTICE_FUNC),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ...
    AWAIT_CUE(7),
    WAIT(20),
    MOVE_RELATIVE(0x100, 0x0, -0xC),
    AWAIT_CUE(7),
    CALL_SCRIPT(LOOK_AROUND_FUNC),
    AWAIT_CUE(7),
    CALL_SCRIPT(JUMP_SURPRISE_FUNC),
    AWAIT_CUE(7),
    WALK_DIRECTION(64, 0x200, 0x4),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g23_s0_lives4_dlg0[] = { /* 0x81513c8 */
    ...
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 77),
    AWAIT_CUE(8),
    ROTATE_TO_LIVES(8, DIR_TRANS_11, 91),
    AWAIT_CUE(8),
    CALL_SCRIPT(SMILE_START_FUNC),
    WAIT(30),
    CALL_SCRIPT(SMILE_END_FUNC),
...
static const struct ScriptCommand s_gs1_g23_s0_lives5_dlg0[] = { /* 0x81516e8 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x4, 0x0),
    AWAIT_CUE(9),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 80),
    AWAIT_CUE(9),
    ROTATE_TO_LIVES(8, DIR_TRANS_11, 91),
    AWAIT_CUE(9),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 85),
    ...
    AWAIT_CUE(9),
    WAIT(2),
    ROTATE_TO_LIVES(60, DIR_TRANS_11, 93),
    AWAIT_CUE(9),
    WAIT(2),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 0),
    AWAIT_CUE(9),
...
static const struct ScriptCommand s_gs1_g23_s0_lives7_dlg0[] = { /* 0x8151e18 */
    ...
    ROTATE_TO(8, DIR_TRANS_10, DIRECTION_NORTHEAST),
    AWAIT_CUE(11),
    WALK_DIRECTION(8, 0x80, 0x3),
    AWAIT_CUE(11),
    ROTATE_TO_LIVES(4, DIR_TRANS_11, 91),
    AWAIT_CUE(11),
    WALK_DIRECTION(24, 0x80, 0x4),
    WALK_DIRECTION(5, 0x80, 0x6),
    ALERT_CUE(5),
    AWAIT_CUE(11),
    HALT,
};
...
static const struct ScriptCommand s_gs1_g26_s0_lives0_dlg0[] = { /* 0x8154794 */
    ...
    CLEAR_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x8, 0x58),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x9, 0x67),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    WAIT_FADE,
    WAIT(30),
    ALERT_CUE(6),
    ...
    ALERT_CUE(6),
    ALERT_CUE(7),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 77),
    WAIT(30),
    PORTRAIT(PLACEMENT_MIDRIGHT_TOP_FLIP, 0x0002, 0x00000000),
    ...
    ALERT_CUE(11),
    ALERT_CUE(20),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 105),
    WAIT(60),
    ...
    ALERT_CUE(10),
    ALERT_CUE(20),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 106),
    WAIT(60),
...
static const struct ScriptCommand s_gs1_g26_s0_lives1_dlg0[] = { /* 0x8156884 */
  ...
  LABEL(0), /* = 0x00 */
    ...
    JUMP_LABEL(0),
  LABEL(1), /* = 0x01 */
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 85),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 0),
    AWAIT_CUE_COND(5, 0),
    AWAIT_CUE(6),
    SET_DIR_WAIT(DIRECTION_SOUTH, 0),
    MOVE_RELATIVE(0x100, 0x0, -0x10),
    AWAIT_CUE_COND(5, 0),
    AWAIT_CUE(6),
    ROTATE_TO(4, DIR_TRANS_10, DIRECTION_EAST),
    WAIT(15),
...
static const struct ScriptCommand s_gs1_g28_s0_lives0_dlg0[] = { /* 0x815aae0 */
  ...
  LABEL(18), /* = 0x12 */
    ...
    ALERT_CUE(20),
    ALERT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINRIGHT1, 85),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_MIDLEFT_TOP, 0x0004, 0x00000003),
    MSG_NPC(4, _(" ...Ugeh?")),
    TEXTBOX_CLEAR,
...
static const struct ScriptCommand s_gs1_g28_s0_lives1_dlg0[] = { /* 0x815dbb8 */
    ...
    ALERT_CUE(5),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINLEFT1, 104),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 105),
    AWAIT_CUE(6),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 106),
...
static const struct ScriptCommand s_gs1_g28_s0_lives7_dlg0[] = { /* 0x815ed38 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x2, 0x0),
    AWAIT_CUE(7),
    ROTATE_TO_LIVES(4, DIR_TRANS_SPINRIGHT1, 34),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO(4, DIR_TRANS_SPINLEFT1, DIRECTION_EAST),
    WAIT(60),
...
static const struct ScriptCommand s_gs1_g28_s0_lives9_dlg0[] = { /* 0x815f428 */
  ...
  LABEL(1), /* = 0x01 */
    ...
    WAIT(30),
    WALK_GRID(76, 110),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 142),
    SELECT_ANIMATION(4),
    AWAIT_CUE(20),
    SELECT_ANIMATION(2),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 34),
...
static const struct ScriptCommand s_gs1_g28_s0_lives14_dlg0[] = { /* 0x8160898 */
    ...
    CALL_SCRIPT(SHOCK_FUNC),
    AWAIT_CUE(20),
    ROTATE_TO_LIVES(8, DIR_TRANS_10, 136),
    WAIT(30),
    WALK_GRID(128, 111),
    SELECT_ANIMATION(4),
    ALERT_CUE(5),
    ...
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 85),
    AWAIT_CUE(20),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 136),
    SELECT_ANIMATION(4),
    AWAIT_CUE(20),
    WAIT(30),
    SELECT_ANIMATION(2),
...
static const struct ScriptCommand s_gs1_g29_s0_lives6_dlg2[] = { /* 0x81617c4 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x4D),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x68),
    WAIT(1),
    PORTRAIT(PLACEMENT_LEFT_BOTTOM_2, 0x0002, 0x00000000),
    PORTRAIT(PLACEMENT_RIGHT_BOTTOM_FLIP, 0x0003, 0x00000000),
...
static const struct ScriptCommand s_gs1_g29_s0_lives8_dlg2[] = { /* 0x8161a88 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x4F),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x69),
    WAIT(1),
    PORTRAIT(PLACEMENT_LEFT_BOTTOM_2, 0x0002, 0x00000000),
    PORTRAIT(PLACEMENT_RIGHT_BOTTOM_FLIP, 0x0003, 0x00000000),
...
static const struct ScriptCommand s_gs1_g29_s0_lives10_dlg2[] = { /* 0x8161dcc */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x55),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x6A),
    WAIT(1),
    PORTRAIT(PLACEMENT_LEFT_BOTTOM_2, 0x0002, 0x00000000),
    PORTRAIT(PLACEMENT_RIGHT_BOTTOM_FLIP, 0x0003, 0x00000000),
...
static const struct ScriptCommand s_gs1_g30_s0_lives6_dlg2[] = { /* 0x8162d2c */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x2, 0x68),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x69),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x4, 0x6A),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x5, 0x6B),
    WAIT(1),
    PORTRAIT(0, 0x5, -2),
...
static const struct ScriptCommand s_gs1_g31_s0_lives0_dlg0[] = { /* 0x81641b8 */
    ...
    FLASH_FROM(TRUE, PALUTIL_KIND_01, 15, RGB_U32(0xFF, 0xFF, 0xFF)),
    WAIT(60),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x9, 0x61),
    ALERT_CUE(6),
    AWAIT_CUE(5),
    ROTATE_TO(4, DIR_TRANS_10, DIRECTION_NORTH),
    PORTRAIT_REP(0x0001, 0x00000000),
...
static const struct ScriptCommand s_gs1_g32_s0_lives0_dlg0[] = { /* 0x8166c80 */
    ...
    TEXTBOX_CLEAR,
    WAIT(10),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x7, 0x6C),
    FANFARE_PLAY2(487),
    FLASH_TO(TRUE, PALUTIL_KIND_01, 15, RGB_U32(0xFF, 0xFF, 0xFF)),
    FLASH_FROM(TRUE, PALUTIL_KIND_01, 15, RGB_U32(0xFF, 0xFF, 0xFF)),
    WAIT(30),
...
static const struct ScriptCommand s_gs1_g41_s0_lives0_dlg3[] = { /* 0x816c958 */
    DEBUGINFO_O(12854),
    SET_OBJ_FLAGS(0x200),
    SET_OBJ_FLAGS(OBJ_FLAG_CANCEL_SCRIPT2),
...
static const struct ScriptCommand s_gs1_g44_s0_lives0_dlg2[] = { /* 0x816d78c */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x1, 0x73),
    PORTRAIT(PLACEMENT_LEFT_BOTTOM_2, 0x0001, 0x00000001),
...
static const struct ScriptCommand s_gs1_g46_s0_lives0_dlg0[] = { /* 0x816e9f8 */
  ...
  LABEL(8), /* = 0x08 */
    ...
    ALERT_CUE(8),
    ALERT_CUE(10),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 109),
    WAIT(60),
...
static const struct ScriptCommand s_gs1_g46_s0_lives2_dlg0[] = { /* 0x81709ac */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x2, 0x0),
    AWAIT_CUE(7),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 79),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    ROTATE_TO(4, DIR_TRANS_10, DIRECTION_SOUTHWEST),
    ALERT_CUE(5),
    ...
    AWAIT_CUE(7),
    CALL_SCRIPT(NOTICE_FUNC),
    ROTATE_TO_LIVES(4, DIR_TRANS_10, 1),
    ALERT_CUE(5),
    AWAIT_CUE(7),
    CJUMP_VAR(EVENT_LOCAL),
    COND_EQUAL(1, /* to label */ 0),
