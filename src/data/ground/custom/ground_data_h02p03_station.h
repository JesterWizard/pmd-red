...
static const struct GroundEventData s_gs110_g0_s0_evts[] = { /* 0x81f12e0 */
    /*  0 */ {  45,   1,   0,   0, {   0,  41, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  1 */ {   3,  42,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {   3,  42,   0,   0, {  42,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
