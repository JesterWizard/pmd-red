...
static const ScriptRef s_gs144_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs144_g0_s0_station_sref_script }; /* 0x8204cf8 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820539c */
...
const GroundScriptHeader gGroundScript_gs144 = { LPARRAY(s_gs144_groups), s_gs144_links }; /* 0x8205500 */
