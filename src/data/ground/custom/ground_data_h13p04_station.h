...
static const ScriptRef s_gs140_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs140_g0_s0_station_sref_script }; /* 0x82026c4 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x8202a78 */
