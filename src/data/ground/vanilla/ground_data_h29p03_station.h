...
static const struct ScriptCommand s_gs160_g0_s0_station_sref_script[] = { /* 0x820f0c0 */
  ...
  LABEL(7), /* = 0x07 */
    ...
    JUMP_LABEL(8),
  LABEL(8), /* = 0x08 */
    BGM_SWITCH(MUS_FRIEND_AREA_ENCLOSED_ISLAND),
    JUMP_SCRIPT(COMMON_ENTER),
};

static const ScriptRef s_gs160_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs160_g0_s0_station_sref_script }; /* 0x820f33c */
...
static const struct GroundEventData s_gs160_g0_s0_evts[] = { /* 0x820f5a0 */
    ...
    /*  1 */ {  60,   1,   0,   0, {   1,  41, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {   3,  42,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  3 */ {   3,  42,   0,   0, {  57,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
};

static const ScriptRef * const (sStationScripts[]) = { /* 0x820f5d0 */
...
const GroundScriptHeader gGroundScript_gs160 = { LPARRAY(s_gs160_groups), s_gs160_links }; /* 0x820f6e4 */
