...
static const ScriptRef s_gs156_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs156_g0_s0_station_sref_script }; /* 0x820bb48 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820bfe4 */
...
const GroundScriptHeader gGroundScript_gs156 = { LPARRAY(s_gs156_groups), s_gs156_links }; /* 0x820c120 */
