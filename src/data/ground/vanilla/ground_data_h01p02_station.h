...
static const struct GroundEventData s_gs106_g0_s0_evts[] = { /* 0x81ef398 */
    /*  0 */ {   1,  42,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  1 */ {  60,   1,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {  60,   1,   0,   0, {   1,  41, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
