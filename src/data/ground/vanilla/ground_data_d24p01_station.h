...
static const struct ScriptCommand s_gs220_g2_s0_lives0_dlg0[] = { /* 0x826c278 */
    ...
    SELECT_ANIMATION(2),
    UPDATE_NAME(UPDATE_NAME_ACTOR_SELF, 0x0, 0x0),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x4, 0x21),
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x3, 0x52),
    WAIT_FADE,
    WAIT(80),
