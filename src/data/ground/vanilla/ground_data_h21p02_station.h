...
static const ScriptRef s_gs149_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs149_g0_s0_station_sref_script }; /* 0x8207de8 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x82085ac */
...
const GroundScriptHeader gGroundScript_gs149 = { LPARRAY(s_gs149_groups), s_gs149_links }; /* 0x8208728 */
