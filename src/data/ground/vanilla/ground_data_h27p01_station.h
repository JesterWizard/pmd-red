...
static const struct ScriptCommand s_gs155_g0_s0_station_sref_script[] = { /* 0x820b294 */
  ...
  LABEL(7), /* = 0x07 */
    ...
    JUMP_LABEL(8),
  LABEL(8), /* = 0x08 */
    BGM_SWITCH(MUS_FRIEND_AREA_STRATOS_LOOKOUT),
    JUMP_SCRIPT(COMMON_ENTER),
};

static const ScriptRef s_gs155_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs155_g0_s0_station_sref_script }; /* 0x820b510 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820b7a4 */
...
const GroundScriptHeader gGroundScript_gs155 = { LPARRAY(s_gs155_groups), s_gs155_links }; /* 0x820b8b8 */
