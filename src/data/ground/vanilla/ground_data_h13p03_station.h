...
static const struct GroundEventData s_gs139_g0_s0_evts[] = { /* 0x82022d8 */
    /*  0 */ {  58,   3,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  1 */ {  58,   1,   0,   0, {   0,  38, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
    /*  2 */ {   3,  40,   0,   0, {   0,   0, 0, 0 }, &gFunctionScriptTable[GETOUT_HABITAT] },
...
const GroundScriptHeader gGroundScript_gs139 = { LPARRAY(s_gs139_groups), s_gs139_links }; /* 0x8202434 */
