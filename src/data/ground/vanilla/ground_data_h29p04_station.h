...
static const struct ScriptCommand s_gs161_g0_s0_station_sref_script[] = { /* 0x820f6f8 */
  ...
  LABEL(7), /* = 0x07 */
    ...
    JUMP_LABEL(8),
  LABEL(8), /* = 0x08 */
    BGM_SWITCH(MUS_FRIEND_AREA_FINAL_ISLAND),
    JUMP_SCRIPT(COMMON_ENTER),
};

static const ScriptRef s_gs161_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs161_g0_s0_station_sref_script }; /* 0x820f974 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820fc08 */
...
const GroundScriptHeader gGroundScript_gs161 = { LPARRAY(s_gs161_groups), s_gs161_links }; /* 0x820fd1c */
