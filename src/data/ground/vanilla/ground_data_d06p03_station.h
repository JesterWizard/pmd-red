...
static const struct ScriptCommand s_gs190_g1_s0_lives0_dlg0[] = { /* 0x823ac18 */
    ...
    UPDATE_NAME(UPDATE_NAME_ACTOR_TYPE, 0x6, 0x55),
    WAIT_FADE,
    WAIT(60),
...
static const struct ScriptCommand s_gs190_g1_s0_lives6_dlg0[] = { /* 0x823d050 */
    ...
    AWAIT_CUE(9),
    CLEAR_OBJ_FLAGS(OBJ_FLAG_INTERACT_MASK),
    WALK_RELATIVE_DIST(0x180, 0x22, -0x1A),
