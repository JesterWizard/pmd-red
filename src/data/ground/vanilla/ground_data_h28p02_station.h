...
static const ScriptRef s_gs157_g0_s0_station_sref = { ENTER_CONTROL, SCRIPT_TYPE_01, NULL, s_gs157_g0_s0_station_sref_script }; /* 0x820c3b0 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x820c758 */
...
const GroundScriptHeader gGroundScript_gs157 = { LPARRAY(s_gs157_groups), s_gs157_links }; /* 0x820c884 */
