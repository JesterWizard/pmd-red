...
static void UpdateBGControlRegisters(void)
{
    ...
    if (gTitleBg8bpp) {
        /* Maps at SCREENBASE 4–7 (0x2000–0x3FFF); 8bpp tiles CHARBASE1 (0x4000–0xFFFF). */
        REG_BG0CNT = BGCNT_Priority[BG0] | BGCNT_SCREENBASE(4) | BGCNT_CHARBASE(0) | BGCNT_WRAP;
        REG_BG1CNT = BGCNT_Priority[BG1] | BGCNT_SCREENBASE(5) | BGCNT_CHARBASE(0) | BGCNT_WRAP;
        REG_BG2CNT = BGCNT_Priority[BG2] | BGCNT_SCREENBASE(6) | BGCNT_CHARBASE(0) | BGCNT_WRAP;
        REG_BG3CNT = BGCNT_Priority[BG3] | BGCNT_SCREENBASE(7) | BGCNT_CHARBASE(1) | BGCNT_256COLOR;
    }
    else {
