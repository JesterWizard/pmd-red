...
static void UpdateBGControlRegisters(void)
{
    ...
    if (gTitleBg8bpp) {
        /* BG0–2 maps at SB 6–8 (0x3000+, above Continue window tiles);
         * BG3 map at SB 31 (0xF800); 8bpp tiles CHARBASE1 @ 0x6000–0xF5FF. */
        ...
        REG_BG2CNT = BGCNT_Priority[BG2] | BGCNT_SCREENBASE(8) | BGCNT_CHARBASE(0) | BGCNT_WRAP;
        REG_BG3CNT = BGCNT_Priority[BG3] | BGCNT_SCREENBASE(31) | BGCNT_CHARBASE(1) | BGCNT_256COLOR;
    }
